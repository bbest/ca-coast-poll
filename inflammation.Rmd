...
The data sets are stored in [comma-separated values](http://swcarpentry.github.io/r-novice-inflammation/reference.html#comma-separated-values-csv) (CSV) format. Each row holds the observations for just one patient. Each column holds the inflammation measured in a day, so we have a set of values in successive days.
...
The expression `read.csv(...)` is a [function call](http://swcarpentry.github.io/r-novice-inflammation/reference.html#function-call) that asks R to run the function `read.csv`.

`read.csv` has two [arguments](http://swcarpentry.github.io/r-novice-inflammation/reference.html#argument): the name of the file we want to read, and whether the first line of the file contains names for the columns of data.
The filename needs to be a character string (or [string](http://swcarpentry.github.io/r-novice-inflammation/reference.html#string) for short), so we put it in quotes. Assigning the second argument, `header`, to be `FALSE` indicates that the data file does not have column headers. We'll talk more about the value `FALSE`, and its converse `TRUE`, in lesson 04. In case of our `inflammation-01.csv` example, R auto-generates column names in the sequence `V1` (for "variable 1"), `V2`, and so on, until `V40`.
...
<img src="./figures/tag-variables.svg" alt="Variables as Tags" />
...
<img src="./figures/arithmetic-variables.svg" alt="Variables as Tags" />
...
<img src="./figures/reassign-variables.svg" alt="Reassigning Variables" />
...
<img src="./figures/new-variables.svg" alt="Creating Another Variable" />
...
<img src="./figures/memory-variables.svg" alt="Updating a Variable" />
...
> > {: .language-r}
> > 
> > <img src="./figures/mass-age-assign-1.svg" alt="Assigning Variables" />
> >
> > ~~~
> > mass <- mass * 2.0
> > age <- age - 20
...
> > {: .language-r}
> > 
> > <img src="./figures/mass-age-assign-2.svg" alt="Assigning Variables" />
> > 
> {: .solution}
{: .challenge}
...
We can see the shape, or [dimensions](http://swcarpentry.github.io/r-novice-inflammation/reference.html#dimensions-of-an-array), of the data frame with the function `dim`:
...
If we want to get a single value from the data frame, we can provide an [index](http://swcarpentry.github.io/r-novice-inflammation/reference.html#index) in square brackets. The first number specifies the row and the second the column:
...
> You can learn more about subsetting by column name in this supplementary [lesson](http://swcarpentry.github.io/r-novice-inflammation/10-supp-addressing-data/).
{: .callout}
...
<img src="./figures/r-operations-across-margins.svg" alt="Operations Across Margins" />
